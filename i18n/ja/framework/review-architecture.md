...
> **言語 / Language**: [简体中文](../../../framework/review-architecture.md) · [English](../../en/framework/review-architecture.md) · **日本語** · [繁體中文](../../zh-TW/framework/review-architecture.md)

---

# 三者並行レビューアーキテクチャ

> **フレームワークドキュメント** — データ依存性に基づいてレビュー次元を分割し、並行レビューを実現するコアイノベーション
> これはマルチエージェント編集システムにおいて最も効率を向上させる設計パターンです
...
従来の方法: 1人のレビュアーが**すべての次元**のレビューを行う。
...
3つの独立したレポートが完成したら、メインオーケストレーターAgentが統合レポートとしてマージします。
...
三者レビューアーキテクチャはN者レビューに拡張できます。重要なのは、新しい次元が**独立したデータ要件**を持つことを確認することです。
