...
> **語言 / Language**: [简体中文](../../../framework/review-architecture.md) · [English](../../en/framework/review-architecture.md) · [日本語](../../ja/framework/review-architecture.md) · **繁體中文**

---

# 三審並行架構

> **框架文檔** — 按數據依賴分割審查維度，實現並行審查的核心創新
> 這是多Agent編輯系統中效率提升最顯著的設計模式
