...
- 保持框架的**通用性**——不要加入特定项目的内容
- Agent 提示词设计应**与具体 LLM 厂商无关**（不写死 Claude/GPT）
...
本项目遵循 [Contributor Covenant v2.1](https://www.contributor-covenant.org/version/2/1/code_of_conduct/)。请友善对待每一位社区成员。
